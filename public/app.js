...
/* harmony import */ var _modules_searchMovies__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/searchMovies */ "./src/modules/searchMovies.js");


(0,_modules_renderForm__WEBPACK_IMPORTED_MODULE_0__["default"])();
(0,_modules_searchMovies__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
/* harmony export */ });
var ajaxService = function ajaxService(t) {
  var url = "http://www.omdbapi.com/";
  var key = 'e4db3ced';
  return fetch("".concat(url, "?t=").concat(t, "&apikey=").concat(key)).then(function (response) {
...
var form = function form() {
  return "<div class=\"form-group mb-2\">\n        <input type=\"text\" class=\"form-control term\" placeholder=\"\u012Eveskite filmo pavadinim\u0105\">\n    </div>\n    <button lang=\"lt\" type=\"submit\" class=\"btn btn-primary\">Ie\u0161koti</button>\n    ";
};
...
var renderMovie = function renderMovie(movie) {
  ...
  var image = "https://st4.depositphotos.com/14953852/22772/v/600/depositphotos_227725020-stock-illustration-image-available-icon-flat-vector.jpg";
  element.className = 'col-12';
  element.innerHTML = "\n<div class=\"title-wraper\">\n<div> Plakatas: <br> <img src=\"".concat(movie.Poster !== 'N/A' ? movie.Poster : image, "\"/></div>\n<div> Trukm\u0117: ").concat(movie.Runtime, "</div>\n<div> Re\u017Eisierius: ").concat(movie.Director, "</div>\n<div> Aktoriai: ").concat(movie.Actors, "</div>\n<div> IMDB reitingas: ").concat(movie.imdbRating, "</div>\n</div>\n");
  return element;
};
...
/* harmony import */ var _renderMovie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderMovie */ "./src/modules/renderMovie.js");
  ...
  document.querySelector('form').addEventListener('submit', function (e) {
    ...
    (0,_ajaxService__WEBPACK_IMPORTED_MODULE_0__["default"])(searchTerm).then(function (result) {
      ...
      if (result.Response !== 'False') {
        ...
        document.querySelector('main .result').appendChild((0,_renderMovie__WEBPACK_IMPORTED_MODULE_1__["default"])(result));
      } else {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjstraining"] = self["webpackChunkjstraining"] || [];
